...
const KhaoSat = () => {
  return <div className="KhaoSat">
    <div className="form-container">
      ...
      <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdcEr2mBF8WDL8LumUISFNeRKzcCNaNGDNi8kWKrYZZtg_nDA/viewform?embedded=true" width="100%" height="100%" frameBorder="0">Đang tải…</iframe>
    </div>
  </div>
}
