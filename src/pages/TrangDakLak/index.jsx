...
function filterNames(list, keyword) {
   ...
   return list.filter((item) => removeVietnameseTones(item.name).includes(normalizedKeyword));
}
         ...
         <div className="daklak-page-container">
            ...
            <div className="ward-container">
               <Card shaded>
                  <Card.Header as="h2">
                     <div className="title">
                        Danh sách các phường xã của tỉnh <span>Đăk Lăk</span>
                     </div>
                  </Card.Header>
                  <Card.Body>
                     <InputGroup>
